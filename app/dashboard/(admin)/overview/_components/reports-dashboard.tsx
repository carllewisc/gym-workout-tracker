      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Analytics and insights for your workout tracking platform
          </p>
        </div>
        ...
        <TabsContent value="overview" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Daily active users, workouts, and exercise logs
              </CardDescription>
            </CardHeader>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Percentage of exercises by muscle group
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Most frequently used equipment types
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                This section will contain detailed analytics about user behavior, workout patterns, and exercise preferences.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
        <TabsContent value="reports" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Coming soon: Customizable report generation
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground">
                This section will allow you to generate custom reports based on various metrics and export them in different formats.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
